...
$$T^2-T+a=0 \\T = \frac{1-\sqrt{1-4a}}{2}$$
...
[Zippers](http://learnyouahaskell.com/zippers) means we could focus on one element in a data structure, and updating the focused element , as well as moving the focus around, takes O(1) time.
