...
{% katex %} \Delta X_0 = \left(\left.\frac{\partial F}{\partial X}\right|_{X=X_0}\right)^{'}F(X_0) {% endkatex %}

{% katex %} X_1=X_0+\Delta X_0 {% endkatex %}
...
{% katex %} \frac{\Gamma \vdash t : [X\rightarrow U]T}{\Gamma \vdash \{*U, t\}\ as\ \{\exists X, T\} : \{\exists X, T\}} {% endkatex %}
